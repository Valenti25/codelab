      ...
      >
            ...
            >
               ...
               {showHandlebar && (
                  <div className="absolute top-1/2 -right-2.5 z-30 flex h-5 w-5 -translate-y-1/2 items-center justify-center rounded-md bg-white shadow-[0px_-1px_0px_0px_#FFFFFF40]">
                     {/* <TbDotsVertical className="h-4 w-4 text-black" /> */}
                     <svg
                        stroke="currentColor"
                        fill="none"
                        strokeWidth="2"
         ...
         <div className="pointer-events-none relative z-20 h-full w-full overflow-hidden">
            <AnimatePresence initial={false}>
               {firstImage ? (
                  <motion.div
                     layout="position"
                     layoutId="compare-first-image"
                     className={cn('absolute inset-0 z-20 h-full w-full flex-shrink-0 overflow-hidden rounded-2xl select-none', firstImageClassName)}
                     style={{
                  ...
                  >
                     <img
                        alt="first image"
                        src={firstImage}
                        className={cn('absolute inset-0 z-20 h-full w-full flex-shrink-0 rounded-2xl select-none', firstImageClassName)}
                        draggable={false}
                     />
                  </motion.div>
               ) : null}
         ...
         <AnimatePresence initial={false}>
            {secondImage ? (
               <motion.img
                  layout="position"
                  layoutId="compare-second-image"
                  className={cn('absolute top-0 left-0 z-[19] h-full w-full rounded-2xl select-none', secondImageClassname)}
                  alt="second image"
                  src={secondImage}
                  draggable={false}
               />
